...
<div class="container">
    <form action="<?=base_url()?>content/edit/<?=$content->id?>" method="POST">
    <div class="form-group row">
                <label for="date" class="col-4 col-form-label">Date</label> 
                <div class="col-8">
                <input id="targetdate" name="targetdate" value="<?=set_value('targetdate',$content->targetdate)?>" placeholder="YYYY-DD-MM" type="text" required="required" class="form-control">
                </div>
            </div>
            <div class="form-group row">
                <label for="achieve" class="col-4 col-form-label">Achieve</label> 
                <select id="achieve" name="achieve" value="<?=set_value('achieve',$content->achieve)?>" class="form-control" required="required">
            ...
            <div class="form-group row">
                ...
                <div class="col-8">
                    <textarea id="targetoutcome" name="targetoutcome" cols="40" rows="5" class="form-control"><?=set_value('targetoutcome',$content->targetoutcome)?></textarea>
                </div>
            </div>
            <div class="form-group row">
                <label for="activities" class="col-4 col-form-label">Actvities</label> 
                <div class="col-8">
                    <textarea id="activities" name="activities" cols="40" rows="5" class="form-control"><?=set_value('activities',$content->activities)?></textarea>
                </div>
            </div>
            <div class="form-group row">
                <label for="accomplished" class="col-4 col-form-label">Accomplished</label> 
                <div class="col-8">
                    <input id="accomplished" name="accomplished" value="<?=set_value('accomplished',$content->accomplished)?>" type="text" class="form-control">
                </div>
            </div> 
            <div class="form-group row">
                <div class="offset-4 col-8">
                    <button name="submit" type="submit" class="btn btn-primary">Update Content</button>
                </div>
            </div>
    </form>
</div>
